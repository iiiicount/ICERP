...
public enum ErrorCode {
    ...
    AUTHENTICATION_FAILED(401, "AUTHENTICATION_FAILED", "AUTHENTICATION_FAILED"),
    USERNOTFOUND(400, "USERNOTFOUND-ERR-400", "USER NOT FOUND"),
    FORBIDDEN(403,"AUTHORIZATION-ERR-403", "NOAUTHORIZATION"),
    BLOCKEDUSER(403, "BLOCKED_USER", "BLOCKED_USER"),
    SERVICE_UNAVAILABLE(503, "SERVICE-ERR-503", "THIS SERVICE ENDED"),
    DB_ERROR(600, "DATA-ERR-600", "NO DATA"),
    NOT_EXIST_TARGET(400, "BAD-REQUEST-400", "NOT EXIST TARGET"),
    WRONG_DATA(400, "WRONG_DATA_400", "WRONG DATA");
